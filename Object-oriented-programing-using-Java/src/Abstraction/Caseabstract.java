...
// TODO Auto-generated method stub
		...
		do {
			...
			if (em.contentEquals("yes") == true) {
				String em1=r.email();
				r.show(name, address, contact, em1, prooftype, proofid);
			}
...
interface show {
	public void show(String name, String address, String contact, String email, String prooftype, String proofid);
}
